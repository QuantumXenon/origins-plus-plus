...
execute as @e[type=!#origins-plus-plus:untargetable,distance=..2] at @s store result score @s lwi_TestC run power has @s origins-plus-plus:witch-of-ink/color/green

execute as @e[type=!#origins-plus-plus:untargetable,distance=..2] at @s if score @s lwi_TestC matches 1 run function origins-plus-plus:witch-of-ink/brush/yellow
