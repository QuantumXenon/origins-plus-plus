...
execute unless data storage origins-plus-plus:temp temppos1 unless data storage origins-plus-plus:temp pos1 run data modify storage origins-plus-plus:temp pos1 set from entity @s Pos
...
execute if data storage origins-plus-plus:temp pos2 run data remove storage origins-plus-plus:temp temppos1
execute if data storage origins-plus-plus:temp pos2 run data remove storage origins-plus-plus:temp Motion
execute if data storage origins-plus-plus:temp pos2 run data remove storage origins-plus-plus:temp pos1
execute if data storage origins-plus-plus:temp pos2 run data remove storage origins-plus-plus:temp pos2
