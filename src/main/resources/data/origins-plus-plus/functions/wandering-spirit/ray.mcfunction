execute if score #hit Wandering_Spirit matches 0 positioned ~-0.05 ~-0.05 ~-0.05 as @e[type=#origins-plus-plus:entities,tag=!rayc,dx=0,sort=nearest] run function origins-plus-plus:wandering-spirit/check_hit_entity
