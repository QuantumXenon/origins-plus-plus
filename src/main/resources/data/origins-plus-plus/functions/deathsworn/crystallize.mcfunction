...
summon minecraft:item ~ ~ ~ {Tags:["Petrified_Heart"],Glowing:1b,CustomModelData:1,PickupDelay:1,Item:{id:"minecraft:heart_of_the_sea",Count:1b,tag:{lnc:1,display:{Name:'{"translate":"origins-plus-plus.deathsworn.petrified_heart","color":"#786C6C","bold":false,"italic":false}'}}}}
