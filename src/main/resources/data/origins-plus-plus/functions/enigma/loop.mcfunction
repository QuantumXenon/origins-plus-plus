...
execute as @e[tag=Enigma_Clone,nbt=!{HurtTime:0s}] at @s run effect clear @a[distance=..16] minecraft:invisibility
execute as @e[tag=Enigma_Clone,nbt=!{HurtTime:0s}] at @s run particle minecraft:smoke ~ ~1 ~ 0.5 0.5 0.5 0.05 100
execute as @e[tag=Enigma_Clone,nbt=!{HurtTime:0s}] at @s run tp @s 0 -999 0
...
execute as @e[scores={Enigma2=1..}] at @s run particle minecraft:smoke ~ ~0.75 ~ 0.25 0.5 0.25 0.025 5
